            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Lista de Inventario</h1>
                        <div class="card mb-2">
                            <div class="card-body">
                                <div class="card-body px-0">
                                    <a href="inventario_registrar_html.php" class="btn btn-primary">Registrar en Inventario</a>
                                </div>
                                ...
                                <table  class="table table-striped">
                                    ...
                                    <tbody>
                                      <?php foreach($data["Detalles"] as $inventario): ?>
                                      <tr>
                                        <td><?= $inventario["prod_nombre"] ?></td>
                                        <td><?= $inventario["prov_nombre"] ?></td>
                                        <td><?= $inventario["inv_tipo_movimiento"] ?></td>            
